# Generated by Django 5.1.2 on 2024-12-12 16:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('tutor', 'Tutor'), ('not specified', 'Not Specified'), ('admin', 'Admin')], default='student', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('rate', models.DecimalField(decimal_places=2, default=10.0, max_digits=6, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('subjects', models.ManyToManyField(related_name='tutors', to='tutorials.subject')),
