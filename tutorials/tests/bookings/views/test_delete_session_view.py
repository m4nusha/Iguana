...
class DeleteSessionViewTest(TestCase):
    ...
    def test_get_delete_session(self):
        ...
        self.assertTemplateUsed(response, 'sessions/session_delete.html')
    ...
    def test_booking_preservation(self):
        """ensure the booking is not deleted when the session is deleted"""
        self.client.login(username='student_user', password='password123')
